...
class DLForgetPsdController: DLBaseViewController {
    ...
    @IBAction func forgetPsd() {
        ...
        DLNewWork.request(url: users_resetPwd,method:.post, parameters: parameters, succeed: { (result) in
